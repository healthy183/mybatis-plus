package org.kang.plus.generator;
...
public class GeneratorTest {
    ...
    public static void getCode() {
        //TODO 修改为自己的数据库信息
        String url = "jdbc:mysql://localhost:3306/spring?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai";
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .globalConfig(builder -> {
                    builder
                            .author("healthy183")//TODO 修改为自己名称
                ...
                .packageConfig(builder ->
                        builder.parent("org.kang.plus")//TODO 修改为自己项目的路径
